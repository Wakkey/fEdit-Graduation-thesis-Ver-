...
uses JSONFormEdit, functionunit, Jsonparse;
...
//  P_type.Add(t5);
  ...
  //if json_pars.obj_sw[json_pars.obj_sw_count-1] = False then
    //function_unit.type_editbox.Text := function_unit.type_editbox.Text + char(13) + P_type.Text + char(13);
  //close;
 ...
 begin
  ...
  inc(json_pars.obj_sw_count);
   ...
   P_type.Add(
    ...
    f := TJsonForm2.Create(function_unit);
    f.obj_fir:= true;
    f.ShowModal;
   ...
   obj_item.Text:= obj_item.Text + f.obj_item.Text;
    ...
    // function_unit.type_editbox.Text + char(13) + P_type.Text;
    f.Free;
   obj_item.Add( s2 + ' エンド');
  //obj_sw[i_obj] := false;
   //P_type.Clear;
...
begin
  for i := 0 to json_pars.obj_sw_count -1 do begin
    ...
    //  function_unit.type_editbox.Add('}');
    end;
  end;
...
//  P_type.Add(t5);
  ...
  if (not json_pars.obj_sw[ json_pars.obj_sw_count ]) or (json_pars.obj_sw_count = 0) then begin
    //function_unit.type_editbox.Text :=
    //  function_unit.type_editbox.Text + char(13) + P_type.Text+ char(13);
   // P_type.Clear;
  end;
